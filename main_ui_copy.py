...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.empContactLabel.setText(_translate("MainWindow", "Contact No.:"))
        self.empEmailLabel.setText(_translate("MainWindow", "Email:"))
        ...
        self.comboBox.setItemText(1, _translate("MainWindow", "Operator"))
        self.comboBox.setItemText(2, _translate("MainWindow", "Driver"))
